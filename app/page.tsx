    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-purple-50">
      ...
      <section className="relative overflow-hidden px-4 pb-20 pt-32">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-6 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-5xl font-extrabold text-transparent md:text-7xl">
            함께하는 돌봄,
            <br />
            새로운 일상의 시작
          </h1>
            ...
            <div>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                ...
                <div className="rounded-xl bg-purple-50 p-4">
                  <div className="mb-1 text-3xl font-bold text-purple-600">500+</div>
                  <div className="text-sm text-gray-600">서비스 제공 가족</div>
                </div>
              </div>
            </div>
